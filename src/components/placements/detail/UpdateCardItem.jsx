...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card.jsx'; // Adjusted
import { Button } from '@/components/ui/button.jsx'; // Adjusted
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "@/components/ui/alert-dialog.jsx"; // Adjusted
...
// No User type definition needed

const UpdateCardItem = ({ update, user, onEdit, onDelete }) => {
  return (
