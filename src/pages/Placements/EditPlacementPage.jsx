  ...
  useEffect(() => {
    if (placementData?.placement) {
      ...
      const defaultValues = {
        ...
        driveRounds: placement.driveRounds ? placement.driveRounds.join(', ') : '',
        selectionProcess: placement.selectionProcess ? (Array.isArray(placement.selectionProcess) ? placement.selectionProcess.join(', ') : placement.selectionProcess) : '',
        ...
        additionalDetails: placement.additionalDetails || '',
        status: placement.status || 'Upcoming',
      };
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>List the different rounds of the selection process.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Selection Process (Optional, additional details)</FormLabel>
                    <FormControl><Textarea placeholder="e.g., Overall selection process description" {...field} value={field.value || ''} rows={3} /></FormControl>
                    <FormDescription>General description of the selection process.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
